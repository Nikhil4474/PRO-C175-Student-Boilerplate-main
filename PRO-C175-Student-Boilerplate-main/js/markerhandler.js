...
AFRAME.registerComponent("markerhandler", {
  ...
  tick: function () {
    if (elementsArray.length > 1) {
      ...
      if (length === 3) {
        var maker1 = document.querySelector(
          `#marker-${elementsArray[0].barcodeValue}`
        )
        var marker2 = document.querySelector(
          `#marker-${elementsArray[1].barcodeValue}`
        )
        var marker3 = document.querySelector(
          `#marker-${elementsArray[2].barcodeValue}`
        )
